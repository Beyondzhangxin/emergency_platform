	...
	<script type="text/javascript">
	 function deleteThreshold() {
         ...
         if(thresholds.length>0){
        	 $.ajax({
     			url:"../threshold_sewage/deleteThreshold.do",
     			type:"post",
	 ...
	 function editThreshold() {
         ...
         if(thresholds.length ==1){
        	 window.open("../threshold_sewage/detail.do?id="+thresholds[0])
         }else{
        	 alert('请选择一个需要编辑的因子。');
         }
	}
 ...
 <p class="content_head_form">
    <span class="content_title_form">报警阀值列表</span>
        <span class="btnbox">
             ...
             <a class="btn2 btn_add" href="../threshold_sewage/detail.do" target="_blank">添加</a>
             <a class="btn2 btn_delete" href="javascript:deleteThreshold()">删除</a>
             <a class="btn2 btn_edit" href="javascript:editThreshold()">编辑</a>
             <a class="btn2 btn_refresh" href="javascript:openUrl('../threshold_sewage/list.do','contentbox')">刷新</a>
        </span>
    <br class="clearfix"/>
</p>
<!--搜索栏-->
<form action="../threshold_sewage/table.do" name="frmSearch" id="frmSearch" method="post">
	<div class="searchbox" >
...
<div class="tablebox" id="tablebox">
     <jsp:include page="/threshold_sewage/table.do"></jsp:include>
</div>